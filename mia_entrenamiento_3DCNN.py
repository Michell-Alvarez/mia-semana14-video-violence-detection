'''
graph LR
    A[Input] --> B[Conv1] --> C[Pool] --> D[Conv2] --> E[Pool] --> F[Conv3] --> G[FC]
'''
...
if __name__ == "__main__":
    ...
    early_stop_limit = 7  # Límite de épocas sin mejora antes de detener el entrenamiento
...
# Bucle principal de entrenamiento: desde la última época guardada hasta la 50
